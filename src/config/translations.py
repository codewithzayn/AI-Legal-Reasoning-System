TRANSLATIONS = {
    "en": {
        ...
        "welcome_subtitle": "Ask about Finnish legislation, court cases (KKO, KHO), or legal definitions in Finnish or English.",
    ...
    "fi": {
        ...
        "send": "Lähetä",
        "welcome_title": "Miten voin auttaa sinua tänään?",
        "welcome_subtitle": "Kysy Suomen lainsäädännöstä, oikeuskäytännöstä (KKO, KHO) tai oikeudellisista määritelmistä suomeksi tai englanniksi.",
