...
class CaseLawStorage:
    ...
    def _insert_case_metadata(self, doc: CaseLawDocument) -> str | None:
        ...
        row = {
            ...
            "judges": doc.judges,
            "judges_total": doc.judges_total,
            "judges_dissenting": doc.judges_dissenting,
            "vote_strength": doc.vote_strength,
            "dissenting_opinion": doc.dissenting_opinion,
            "dissenting_text": doc.dissenting_text,
            "exceptions": getattr(doc, "exceptions", "") or "",
            "weighted_factors": getattr(doc, "weighted_factors", "") or "",
            "trend_direction": getattr(doc, "trend_direction", "") or "",
            "distinctive_facts": getattr(doc, "distinctive_facts", "") or "",
            "ruling_instruction": getattr(doc, "ruling_instruction", "") or "",
            "applied_provisions": getattr(doc, "applied_provisions", "") or "",
            # EU case law fields
